				...
				<article className={Styles.txtWrapper}>
					...
					<section className={Styles.sectionTxt}>
						...
						<p>
							...
							Agency, building performant and accessible web applications based
							on provided requirements
						</p>
						<p>
							Along with this, I have also been working with ECO Afrca as a
							volunteer Frontend Engineer, collaborating with other developers
							to build the ECO platform. This brought a couple of opportunities,
							like a 3-month contract to build a web platform including a
							dashboard, profile and merch store for a religious organization.
						</p>
						<p>
